    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        ...
        <Text style={styles.description}>
          Wait, the whole time? I was screaming for help, and you stayed on the
          roof? Don’t look at me! That guy over there roped me into this. He’s
          not a hot girl.
        </Text>
        {/* Müzik Tarzı */}
        <Text style={styles.sectionTitle}>Müzik Tarzı</Text>
        ...
        <View style={styles.tagRow}>
          ...
          <View style={styles.tag}>
            <Text style={styles.tagText}>Pop-rock</Text>
          </View>
          <View style={styles.tag}>
            <Text style={styles.tagText}>Alternatif</Text>
          </View>
        </View>
        {/* Aradığım Müzisyenler */}
        <Text style={styles.sectionTitle}>Aradığım Müzisyenler</Text>
        <View style={styles.underline} />
        <View style={styles.instrumentRow}>
          ...
          <View style={styles.instrumentTag}>
            ...
            />
            <Text style={styles.instrumentText}>Vokal</Text>
          </View>
          {/* Akustik Gitar */}
          <View style={styles.instrumentTag}>
            <Image
              ...
              style={{ width: 56, height: 56, resizeMode: "contain" }}
            />
            <Text style={styles.instrumentText}>Akustik{"\n"}Gitar</Text>
          </View>
          {/* Diğer enstrümanlar buraya eklenebilir */}
        </View>
      </ScrollView>
      {/* Mesaj Gönder Butonu */}
