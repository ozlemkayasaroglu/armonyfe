  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.headerBar}>
        <Text style={styles.headerTitle}>Müzik Eğitimi</Text>
      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        ...
        <View style={styles.profileRow}>
          ...
          <View style={{ flex: 1, marginLeft: 12 }}>
            <Text style={styles.profileName}>Aslı Teker</Text>
            <View
              style={{
                flexDirection: "row",
                alignItems: "center",
            ...
            >
              ...
              <Text style={styles.profileCity}>İzmir</Text>
            </View>
          </View>
          <TouchableOpacity>
            <DotsIcon />
        ...
        <Text style={styles.description}>
          İstanbul Üniversitesi mezunuyum. 10 senedir bas gitar eğitimi
          veriyorum. Aynı zamanda prodüksiyon tarafıyla ilgili de eğitimler
          veriyorum
        </Text>
        {/* Müzik Tarzı */}
        ...
        <View style={styles.tagRow}>
          <View style={styles.tag}>
            <Text style={styles.tagText}>Bas Gitar</Text>
          </View>
          <View style={styles.tag}>
            <Text style={styles.tagText}>Mastering</Text>
          </View>
          <View style={styles.tag}>
        ...
        {/* Müzik Tarzı */}
        <Text style={styles.sectionTitle}>Eğitim Şekli</Text>
        <View style={styles.underline} />
        <View style={styles.tagRow}>
          <View style={styles.tag}>
            <Text style={styles.tagText}>Yüzyüze</Text>
          </View>
          <View style={styles.tag}>
            <Text style={styles.tagText}>Uzaktan</Text>
          </View>
        </View>
      </ScrollView>
      {/* Mesaj Gönder Butonu */}
