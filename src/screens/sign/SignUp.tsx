...
const EyeOffIcon = (props: React.ComponentProps<typeof Svg>) => (
...
export default function SignIn({
  ...
  const handleSignUp = () => {
    console.log("Kayıt Ol butonu tıklandı!");
  };
    ...
    >
      ...
      >
        ...
        <View style={styles.formContainer}>
          ...
          >
            <Text style={styles.signInButtonText}>Üye Ol</Text>
          </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  signInButtonDisabled: {
    backgroundColor: "#4A3A7D", // Yeni, daha belirgin renk
    opacity: 1,
  },
  signInButtonText: {
    color: "#fff",
